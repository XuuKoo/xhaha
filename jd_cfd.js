...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({
      url: `https://raw.githubusercontent.com/XuuKoo/xhaha/e/jxcfd_sharecode.json`,
      'timeout': 10000
    }, (err, resp, data) => {
      try {
        if (err) {
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    if ($.shareCodesArr[$.index - 1]) {
      ...
      $.newShareCodes = [...$.strMyShareIds, "511B794B1353E421F7F6AC81A7D2D467BF3EBE89F3227045D7CBDA76464231BE"];
    }
